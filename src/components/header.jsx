...
export default function Header() {
  ...
  return (
    <>
      {/* --- Fixed Header --- */}
      <header className="fixed top-0 left-0 w-full bg-blue-500 text-white shadow-md z-[9999] relative">
        <div className="flex justify-between items-center px-6 h-[70px]">
          ...
          <div className="flex items-center space-x-4 relative z-[9999]">
            ...
            <button
              className="md:hidden text-3xl focus:outline-none relative z-[9999]"
        ...
        {/* Mobile Dropdown */}
        {menuOpen && (
          <div className="md:hidden bg-blue-600 w-full flex flex-col items-center 
                          space-y-4 py-4 text-lg font-medium relative z-[9999]">
