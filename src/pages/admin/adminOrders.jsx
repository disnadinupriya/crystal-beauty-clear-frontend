...
export default function AdminOrdersPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 py-4 px-4 sm:px-6 lg:px-8">
      {loaded ? (
        <div className="w-full">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
            ...
            <div className="mt-4 sm:mt-0 relative w-full max-w-sm">
          ...
          <div className="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
                    ...
                    filteredOrders.map((order) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 whitespace-nowrap text-center text-sm font-medium">
                          {/* Removed Delete button from here, only 'View' remains and is wider */}
                          <button
                            onClick={() => {
                              setModelIsDisplaing(true);
                              setDisplaingOrder(order);
                            }}
                            className="text-white bg-indigo-600 hover:bg-indigo-700 px-6 py-1.5 rounded-md transition-colors duration-200 text-xs shadow-sm font-medium w-24"
                          >
                            View
                          </button>
                        </td>
            ...
            {modelIsDisplaing && (
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                <div className="bg-white rounded-xl w-full max-w-2xl shadow-2xl overflow-hidden transform transition-all relative">
                  ...
                  <div className="bg-gray-50 px-6 py-3 border-t border-gray-200 text-right flex justify-between items-center">
                    {/* Delete button is ONLY here now */}
                    <button
                        onClick={() => deleteOrder(displaingOrder.orderId)}
                        className="px-4 py-2 bg-red-50 border border-red-200 rounded-md text-sm font-medium text-red-700 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 flex items-center gap-2 transition-colors"
                    >
