      ...
      {status === "loaded" && (
        <div className="w-full h-full flex flex-wrap justify-center">
          ...
          <div className="w-[50%] h-full p-8">
            <h1 className="text-3xl font-bold mb-4 text-center mb-4">
              {product.name}
            </h1>
            <h2 className="text-3xl font-bold mb-4 text-center text-gray-600 text-gray-500">
              {product.altName.join(", ")}
            </h2>
            <div className=" mb-4 flex mb-4 justify-center items-center">
              {product.lablePrice > product.price ? (
                <>
                  <h2 className="text-3xl mr-4 text-center">
                    LKR:{product.price.toFixed(2)}
                  </h2>
                  <h2 className="text-2xl line-through text-gray-500 text-center ">
