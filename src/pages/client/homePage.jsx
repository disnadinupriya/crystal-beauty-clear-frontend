...
const IconLeaf = () => (
  <svg className="w-8 h-8 md:w-10 md:h-10 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
);
const IconStar = () => (
  <svg className="w-8 h-8 md:w-10 md:h-10 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path></svg>
);
const IconHeart = () => (
  <svg className="w-8 h-8 md:w-10 md:h-10 text-pink-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>
);
const IconTrophy = () => (
  <svg className="w-8 h-8 md:w-10 md:h-10 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
);

// --- 1. HERO SECTION (Optimized for Mobile) ---
const HeroSection = () => (
  <section className="relative w-full min-h-[90vh] md:h-[800px] flex items-center justify-center overflow-hidden">
    {/* Background Image */}
    ...
    <div className="relative z-10 text-center px-6 max-w-5xl mx-auto mt-20 md:mt-16 w-full">
      ...
      <div className="inline-block px-4 py-1.5 md:px-6 md:py-2 mb-6 md:mb-8 border border-white/30 rounded-full bg-white/10 backdrop-blur-md shadow-lg animate-fade-in-down">
        <span className="text-white tracking-[0.2em] md:tracking-[0.3em] text-[10px] md:text-sm font-bold uppercase">Pure. Organic. Ethical.</span>
      </div>
      ...
      <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-serif font-bold text-white leading-[1.1] md:leading-tight mb-4 md:mb-6 drop-shadow-2xl animate-fade-in-up">
        ...
        <span className="italic text-emerald-200 relative inline-block mt-1 md:mt-0">
          ...
          <svg className="absolute -bottom-2 left-0 w-full h-2 md:h-4 text-emerald-400 opacity-80" viewBox="0 0 100 10" preserveAspectRatio="none"><path d="M0 5 Q 50 15 100 5" stroke="currentColor" strokeWidth="3" fill="none" /></svg>
        </span>
      </h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center items-center animate-fade-in-up delay-200 w-full sm:w-auto px-4 sm:px-0">
        <Link to="/products" className="w-full sm:w-auto group relative px-8 py-3.5 md:px-10 md:py-4 bg-white text-emerald-900 font-bold rounded-full overflow-hidden shadow-[0_0_25px_rgba(255,255,255,0.4)] transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(255,255,255,0.6)]">
        ...
        <Link to="/contact" className="w-full sm:w-auto text-center px-8 py-3.5 md:px-10 md:py-4 bg-white/10 border border-white/40 text-white font-semibold rounded-full hover:bg-white/20 backdrop-blur-md transition-all hover:border-white text-base md:text-lg">
          Our Story
        </Link>
      </div>
    </div>
    ...
    <div className="container mx-auto px-4 md:px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
        {[
          ...
          <div key={idx} className={`p-6 md:p-8 rounded-[2rem] border ${item.color} hover:shadow-xl transition-all duration-300 group cursor-default flex flex-col items-center md:items-start text-center md:text-left`}>
    ...
    <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
            <div className="text-white space-y-6 md:space-y-8 text-center md:text-left">
                <div>
                    <span className="text-emerald-400 font-bold tracking-widest uppercase text-xs md:text-sm mb-2 block">The Sanctuary</span>
                ...
                <div className="grid grid-cols-3 gap-2 md:gap-4 pt-4">
                    <div className="text-center p-2 md:p-4 bg-white/10 rounded-xl md:rounded-2xl backdrop-blur-sm">
                        <div className="text-xl md:text-3xl font-bold text-emerald-400">13+</div>
                        <div className="text-[10px] md:text-xs text-gray-400 uppercase mt-1">Acres</div>
                    </div>
                    <div className="text-center p-2 md:p-4 bg-white/10 rounded-xl md:rounded-2xl backdrop-blur-sm">
                        <div className="text-xl md:text-3xl font-bold text-emerald-400">800+</div>
                        <div className="text-[10px] md:text-xs text-gray-400 uppercase mt-1">Species</div>
                    </div>
                    <div className="text-center p-2 md:p-4 bg-white/10 rounded-xl md:rounded-2xl backdrop-blur-sm">
                        <div className="text-xl md:text-3xl font-bold text-emerald-400">100%</div>
                        <div className="text-[10px] md:text-xs text-gray-400 uppercase mt-1">Natural</div>
                    </div>
                </div>

                <div className="pt-2">
                    <Link to="/products" className="inline-flex items-center px-8 py-3 md:py-4 bg-emerald-600 hover:bg-emerald-500 text-white rounded-full font-bold transition-all shadow-lg hover:shadow-emerald-500/30 hover:translate-x-2 text-sm md:text-base">
                        Explore Ingredients
                        <svg className="w-4 h-4 md:w-5 md:h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                    </Link>
                </div>
            </div>
  ...
  <section className="py-16 md:py-24 bg-emerald-50/50">
    <div className="container mx-auto px-4 md:px-6">
      <div className="text-center mb-10 md:mb-16">
        <h2 className="text-3xl md:text-5xl font-serif font-bold text-emerald-950 mb-3 md:mb-4">Our Premium Collections</h2>
        <p className="text-gray-600 max-w-2xl mx-auto text-base md:text-lg">Curated ranges for every skin type and lifestyle.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        {[
          ...
          <Link key={brand.id} to={`/products?brand=${brand.name.replace(' ', '')}`} className="group block h-full">
            <div className={`h-full p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gradient-to-br ${brand.gradient} hover:shadow-2xl hover:shadow-gray-200 transition-all duration-500 transform hover:-translate-y-2 relative overflow-hidden flex flex-col`}>
              ...
              <div className="relative z-10 flex-grow">
                ...
                <h3 className={`text-xl md:text-2xl font-serif font-bold mb-2 md:mb-3 ${brand.text}`}>{brand.name}</h3>
                <p className="text-gray-700 font-medium leading-relaxed text-sm md:text-base">{brand.desc}</p>
              </div>

              <div className="relative z-10 mt-6 md:mt-8">
                <span className={`inline-flex items-center justify-center px-5 py-2.5 md:px-6 md:py-3 bg-white rounded-full text-xs md:text-sm font-bold text-gray-800 shadow-sm group-hover:bg-gray-900 group-hover:text-white transition-all duration-300`}>
  ...
  return (
    <div className="relative bg-[#022c22] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl mx-2 md:mx-0 my-8">
      ...
      <div className="relative z-10 px-6 py-12 md:p-20 text-center">
        <h3 className="text-2xl md:text-5xl font-serif font-bold text-white mb-4 md:mb-6">Unlock Nature's Secrets</h3>
        ...
        <form className="max-w-lg mx-auto relative flex flex-col sm:flex-row gap-3 sm:gap-0" onSubmit={handleSubmit}>
          <input 
            value={email} 
          ...
          />
          <button type="submit" className="w-full sm:w-auto sm:absolute sm:right-2 sm:top-2 sm:bottom-2 px-8 py-3 sm:py-0 bg-emerald-500 hover:bg-emerald-400 text-white font-bold rounded-full transition-colors shadow-lg text-sm md:text-base">
            Join
          </button>
        </form>
        <p className="text-emerald-500/60 text-[10px] md:text-xs mt-4">No spam, just pure beauty.</p>
      </div>
    </div>
  );
}
